...
public class SortedMedian {
    ...
    public static void testForSortedMedian(int maxTestTimes) {
        for (int i = 0; i < maxTestTimes; i++) {
            int[] arr1 = SimpleUtil.generateRandomArray(20, 40);
            arr1 = SimpleUtil.deduplicate(arr1);
            Arrays.sort(arr1);
            int[] arr2 = SimpleUtil.generateRandomArray(20, 40);
            arr2 = SimpleUtil.deduplicate(arr2);
            Arrays.sort(arr2);
