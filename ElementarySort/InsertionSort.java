...
public class InsertionSort {
    ...
    public static void testForInsertionSort(int maxTestTimes) {
        for (int i = 0; i < maxTestTimes; i++) {
            ...
            boolean isOrdered = AlgoUtil.isOrdered(arr);
            if (!isOrdered) {
...
//        AlgoUtil.printArr(result);
//        for (int i = 0; i < 1000; i++) {
//            int[] arr1 = AlgoUtil.generateRandomArray(6, 1);
//            int[] arr2 = AlgoUtil.generateRandomArray(6, 1);
//            int[] result = calculateTwoBinaryIntegerSum(arr1, arr2);
//            int convertResult = AlgoUtil.convertIntegerArray2IntegerNumber(result);
//            if (convertResult != AlgoUtil.convertIntegerArray2IntegerNumber(arr1) + AlgoUtil.convertIntegerArray2IntegerNumber(arr2)) {
//                System.out.println("Sorry test failed");
//                return;
//            }
//
